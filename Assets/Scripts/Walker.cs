...
public class Walker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(healthSystem.health <= 0)
        {
            ...
            Instantiate(engineer, head.transform.position + new Vector3(0, 0, 0), Quaternion.identity);

            gameObject.AddComponent<Disable>().timeToDisable = 20;
            Destroy(gameObject.GetComponent<WalkerRaycastManager>());
            ...
            foreach (Transform child in gameObject.transform)
            {
                ...
                Destroy(gameObject.GetComponent<Walker>());
            }
        }
